...
- Privacidade (LGPD): http://localhost:8000/privacidade/
...
Roteiro de treinamento da administração (login, notícias, páginas institucionais, agenda, sermões, ao vivo, publicar/revisar/despublicar): [`docs/treinamento-administracao.md`](docs/treinamento-administracao.md). Política de privacidade, consentimento, menores e retenção: [`docs/privacidade.md`](docs/privacidade.md) (página pública `/privacidade/`). Fotografias da homepage (API oficial do Instagram ou exportação JSON da Meta, sem raspagem): [`docs/ops/instagram-acervo.md`](docs/ops/instagram-acervo.md).
